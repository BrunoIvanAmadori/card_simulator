...
function () {
  function Deck(txt, n) {
    this.name = n;
    this.fetchCardList(this.createCardListFromTxt(txt));
  }

  Deck.prototype.fetchCardList = function (list) {
    return __awaiter(this, void 0, void 0, function () {
      var cardList, cardListKeys, cardListNames, cardListPromises, cardListLoading, cardListCards;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            cardList = list;
            cardListKeys = Object.keys(cardList);
            ...
            cardListLoading = Promise.all(cardListPromises);
            return [4
            /*yield*/
            , cardListLoading];

          case 1:
            cardListCards = _a.sent();
            console.log(cardListCards);
            return [2
            /*return*/
            , cardListCards];
        }
  ...
  Deck.prototype.createCardListFromTxt = function (txt) {
    var lines = txt.split("\n");
